...
path='C:/Users/HP/Documents/face recognition project/imagesattendance/'
images = []
classnames=[]
...
def markAttendance(names):
    with open('C:/Users/HP/Documents/face recognition project/Attendance_sheet.csv','r+') as f:
